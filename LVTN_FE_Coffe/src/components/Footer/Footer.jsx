    ...
    <div style={bgImage} className='text-white'>
      ...
      <div className='container grid md:grid-cols-3 pb-20 pt-5'>
        ...
        <div className='py-8 px-4'>
            <a href="#" className='font-semibold tracking-widest text-2xl sm:text-3xl 'style={{ fontFamily: 'Pacifico, cursive' }}> Coffee Cafe </a>
            <p className='pt-4'>Crafted Coffee, Cozy Vibes, Unforgettable Moments – Your Perfect Espresso Escape</p>
            <a href="https://www.youtube.com/watch?v=UVn3C99p5cc" target='_blank' className='inline-block bg-[#3d2517] py-2
            px-4 mt-5 text-sm rounded-full'>Visit our YouTube</a>
        </div>
          {/* Footer Links   */}
          <div className='col-span-2 grid grid-cols-2 sm:grid-cols-3 md:pl-10'>
              ...
              <ul className='space-y-2 '>
                {
                  FooterLinks.map((data, index) => (
                    <li key={index}>
                      <a href={data.link}
                      className='inline-block hover:scal-105 duration-200'>{data.title}</a>
                    </li>
                ))
                }
              </ul>
            ...
            <div className='py-8 px-4 col-span-2 sm:col-auto'>
              ...
              <div className=''>
                <p className='mb-3'>180 Cao Lo,Tp.HCM</p>
                <p>0123456789</p>
                {/* Social Links */}
