        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="col-span-2 text-sm text-slate-900 dark:text-slate-50">
              {brewingMethod.description || "No description"}
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="col-span-2 text-sm text-slate-900 dark:text-slate-50">
              {new Date(brewingMethod.createdDate).toLocaleString("en-US", {
                dateStyle: "medium",
                timeStyle: "short",
              })}
            </div>
          ...
          {brewingMethod.updatedDate && (
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="col-span-2 text-sm text-slate-900 dark:text-slate-50">
                {new Date(brewingMethod.updatedDate).toLocaleString("en-US", {
                  dateStyle: "medium",
                  timeStyle: "short",
                })}
              </div>
